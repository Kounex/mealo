...
extension TagByIndex on IsarCollection<Tag> {
  Future<Tag?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  Tag? getByUuidSync(String uuid) {
  ...
  Future<List<Tag?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<Tag?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(Tag object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(Tag object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<Tag> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<Tag> objects, {bool saveLinks = true}) {
...
extension TagQueryWhere on QueryBuilder<Tag, Tag, QWhereClause> {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> uuidEqualTo(String uuid) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> uuidNotEqualTo(String uuid) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
