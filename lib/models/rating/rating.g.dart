...
extension RatingByIndex on IsarCollection<Rating> {
  ...
  Future<Rating?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Rating? getByNameSync(String name) {
  ...
  Future<List<Rating?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Rating?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Rating object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Rating object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Rating> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Rating> objects, {bool saveLinks = true}) {
...
extension RatingQueryWhere on QueryBuilder<Rating, Rating, QWhereClause> {
  ...
  QueryBuilder<Rating, Rating, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [name],
  ...
  QueryBuilder<Rating, Rating, QAfterWhereClause> nameNotEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
